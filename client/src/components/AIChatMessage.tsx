  ...
  if (role === "user") {
    return (
      <div className="flex items-start gap-3 justify-end">
        <div className="bg-[var(--accent-soft)] border border-[var(--accent-border)] rounded-xl rounded-br-sm px-3.5 py-2.5 max-w-[80%]">
        ...
        <div className="w-7 h-7 rounded-full bg-[var(--accent-soft)] border border-[var(--accent-border)] flex items-center justify-center shrink-0 mt-0.5">
        ...
        {response && (
          <div>
            <button
              ...
              className="flex items-center gap-1 text-[9px] text-[var(--text-muted)] hover:text-[var(--accent)] transition-colors"
            >
