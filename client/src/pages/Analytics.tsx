    ...
    <div className="min-h-screen bg-[#151B23] p-6">
      <div className="max-w-6xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-[#94A3B8] text-sm mt-1">Performance overview of all your trading bots</p>
        </div>
        ...
        {tradesQuery.isLoading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              {stats.map(s => (
                <div key={s.label} className="bg-[#151B23] border border-[#252B35] rounded-xl p-5">
                  <div className="flex items-center justify-between mb-3">
                    <span className="text-xs text-[#64748B] font-bold uppercase tracking-wider">{s.label}</span>
            ...
            <div className="bg-[#151B23] border border-[#252B35] rounded-xl p-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {riskStats.map(s => (
                  <div key={s.label} className="bg-black/20 border border-[#252B35] rounded-lg p-4">
