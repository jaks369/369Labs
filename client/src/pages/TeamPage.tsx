    ...
    <div className="h-full p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
          <h2 className="text-sm font-bold text-white mb-4 flex items-center gap-2"><UserPlus className="w-4 h-4 text-[var(--accent)]" /> Invite Members</h2>
          <div className="flex gap-2">
            ...
            <Button onClick={invite} disabled={inviteMutation.isPending} className="bg-[var(--accent)] text-[var(--bg)] text-xs px-4">
        ...
        <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-6">
          <h2 className="text-sm font-bold text-white mb-4 flex items-center gap-2"><Share2 className="w-4 h-4 text-[var(--accent)]" /> Sharing</h2>
          ...
          <div className="flex gap-2">
            ...
            <Button onClick={() => { navigator.clipboard.writeText(shareLink); setCopied(true); setTimeout(() => setCopied(false), 2000); }} className="bg-[var(--accent)]/20 text-[var(--accent)] border border-[var(--accent)]/30 text-xs">
