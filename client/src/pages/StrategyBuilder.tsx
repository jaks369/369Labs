...
export default function StrategyBuilder() {
  ...
  return (
    <div className="p-6 lg:p-10 bg-[#0D0D0D] min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <div className="bloomberg-panel p-6 flex flex-col md:flex-row gap-6">
               ...
               <div className="w-px bg-[rgba(255,255,255,0.08)] hidden md:block" />
               <div className="flex-1 space-y-2">
              ...
              <div className="flex-1 p-8 space-y-4">
                {builderMode === "visual" ? (
                  ...
                  <div className="max-w-2xl mx-auto space-y-6">
                    {blocks.length === 0 ? (
                      <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-[rgba(255,255,255,0.08)] rounded-2xl">
