    ...
    <div className="h-full text-[var(--text-primary)] selection:bg-[var(--accent)]/20">
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-5xl mx-auto px-6 pb-16">
          <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="flex md:grid md:grid-cols-6 gap-3 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-none">
            {[
              ...
              <div key={i} className="aurora-glass rounded-lg p-3 text-center snap-start shrink-0 w-[120px] md:w-auto">
        ...
        <section className="max-w-6xl mx-auto px-6 py-20">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            <motion.div variants={fadeUp} className="text-center mb-12">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium text-[var(--accent)] border border-[rgba(77,224,172,0.25)] bg-[rgba(77,224,172,0.08)] mb-4">
                <Activity className="w-3 h-3" /> The System
              </span>
              <h2 className="text-3xl md:text-4xl font-bold text-white tracking-tight mb-3">
                The full loop, <span className="aurora-gradient-text">on one platform.</span>
              </h2>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <div className="space-y-2">
              {[
                ...
                <motion.details key={i} variants={fadeUp} className="aurora-glass rounded-lg group">
                  <summary className="flex items-center justify-between p-3 cursor-pointer text-sm font-medium text-white hover:text-[var(--accent)] transition-colors">
                    {faq.q}
        ...
        <section className="max-w-4xl mx-auto px-6 py-16">
          <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="aurora-glass rounded-xl p-10 text-center">
            ...
            <button onClick={() => navigate("/login")} className="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-full text-black transition-all hover:brightness-110" style={{ background: 'linear-gradient(135deg, #4ade80, #8b5cf6)' }}>
