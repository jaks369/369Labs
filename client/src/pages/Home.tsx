...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-[#F8FAFC] selection:bg-orange-500/30">
      {/* Background Effects */}
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-orange-500/10 blur-[120px] rounded-full opacity-50" />
      ...
      <main className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-400/20 text-orange-300 text-xs font-bold tracking-wider mb-8 animate-fade-in">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold text-white mb-8 tracking-tighter leading-[1.1]">
            Build. Backtest.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-emerald-400">Automate.</span>
          </h1>
          ...
          <div className="mt-24 relative max-w-5xl mx-auto">
            <div className="absolute -inset-1 bg-gradient-to-r from-orange-500 to-emerald-500 rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
            <div className="relative bg-slate-900 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="aspect-video bg-[#0D0D0D] p-8 flex items-center justify-center">
                 <div className="w-full h-full border border-orange-400/20 rounded-lg relative overflow-hidden bg-slate-950">
                    {/* Mock Chart Effect */}
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-orange-400/10 to-transparent" />
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card group hover:border-orange-400/50 transition-colors">
        ...
        {/* CTA Section */}
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="bg-gradient-to-br from-orange-500 to-orange-700 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <a href={getLoginUrl()} className="inline-flex items-center gap-2 px-8 py-4 bg-white text-orange-500 font-bold rounded-xl hover:bg-orange-50 transition-colors relative z-10">
