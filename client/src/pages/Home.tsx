...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#151515] text-[#FFFFFF] selection:bg-[#D98B1F]/30">
      ...
      <main className="relative z-10">
        <section className="max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#D98B1F]/10 border border-[#D98B1F]/20 text-[#E89A2A] text-xs font-bold tracking-wider mb-8 animate-fade-in">
          ...
          <h1 className="text-6xl md:text-8xl font-extrabold text-white mb-8 tracking-tighter leading-[1.1]">
            Build. Backtest.<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D98B1F] to-[#22C55E]">Automate.</span>
          </h1>
          <p className="text-xl text-[#A8A8A8] mb-12 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button onClick={() => navigate("/login")} className="btn-primary text-lg px-10 py-4 w-full sm:w-auto">
              Get Started
            </button>
            <button onClick={() => navigate("/dashboard")} className="btn-outline text-lg px-10 py-4 w-full sm:w-auto">
              Live Demo
            </button>
          </div>

          <div className="mt-24 relative max-w-5xl mx-auto">
            <div className="absolute -inset-1 bg-gradient-to-r from-[#D98B1F] to-[#22C55E] rounded-2xl blur opacity-20 group-hover:opacity-40 transition duration-1000"></div>
            <div className="relative bg-[#151515] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              <div className="h-8 bg-[#151515]/50 border-b border-white/5 flex items-center px-4 gap-1.5">
                <div className="w-2.5 h-2.5 rounded-full bg-[#EF4444]/50" />
                <div className="w-2.5 h-2.5 rounded-full bg-[#D98B1F]/50" />
                <div className="w-2.5 h-2.5 rounded-full bg-[#22C55E]/50" />
              </div>
              <div className="aspect-video bg-[#151515] p-8 flex items-center justify-center">
                 <div className="w-full h-full border border-[#D98B1F]/20 rounded-lg relative overflow-hidden bg-[#0D0D0D]">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-[#D98B1F]/10 to-transparent" />
                    ...
                    <div className="flex items-center justify-center h-full">
                       <Activity className="w-16 h-16 text-[#D98B1F] animate-pulse" />
                    </div>
                 </div>
              </div>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="text-center mb-20">
            ...
            <p className="text-[#A8A8A8]">Everything you need to scale your trading operations.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div onClick={() => navigate("/ai-assistant")} className="glass-card group hover:border-[#D98B1F]/50 transition-colors cursor-pointer">
              <div className="w-12 h-12 bg-[#D98B1F]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Brain className="w-6 h-6 text-[#D98B1F]" />
              </div>
            ...
            <div onClick={() => navigate("/analytics")} className="glass-card group hover:border-[#22C55E]/50 transition-colors cursor-pointer">
            ...
            <div onClick={() => navigate("/cloud-bots")} className="glass-card group hover:border-[#D98B1F]/50 transition-colors cursor-pointer">
              <div className="w-12 h-12 bg-[#D98B1F]/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                <Globe className="w-6 h-6 text-[#D98B1F]" />
              </div>
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="bg-gradient-to-br from-[#D98B1F] to-[#C07B1A] rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <p className="text-[#1A1A1A] text-lg mb-10 max-w-2xl mx-auto relative z-10">
              Join the next generation of algorithmic traders. Start building your first strategy today.
            </p>
            <button onClick={() => navigate("/login")} className="inline-flex items-center gap-2 px-8 py-4 bg-white text-[#D98B1F] font-bold rounded-xl hover:bg-[#1A1A1A] transition-colors relative z-10">
        ...
        <footer className="border-t border-white/5 py-12 px-6">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="flex gap-8 text-sm text-[#6F6F6F]">
              <span className="hover:text-white">&copy; 2026 369Labs. All rights reserved.</span>
            </div>
          </div>
        </footer>
      </main>
