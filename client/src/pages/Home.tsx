      ...
      <main className="relative z-10">
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card group hover:border-blue-500/50 transition-colors">
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <a href={getLoginUrl()} className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors relative z-10">
