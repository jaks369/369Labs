      ...
      <main className="relative z-10">
        <section className="max-w-7xl mx-auto px-6 pt-32 pb-20 text-center">
          ...
          <div className="mt-24 relative max-w-5xl mx-auto">
            ...
            <div className="relative bg-slate-900 border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="aspect-video bg-[#0D1117] p-8 flex items-center justify-center">
                 <div className="w-full h-full border border-blue-500/20 rounded-lg relative overflow-hidden bg-slate-950">
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div onClick={() => navigate("/ai-assistant")} className="glass-card group hover:border-blue-500/50 transition-colors cursor-pointer">
            ...
            <div onClick={() => navigate("/analytics")} className="glass-card group hover:border-emerald-500/50 transition-colors cursor-pointer">
            ...
            <div onClick={() => navigate("/cloud-bots")} className="glass-card group hover:border-blue-500/50 transition-colors cursor-pointer">
              <div className="w-12 h-12 bg-blue-500/10 rounded-xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
        ...
        <section className="max-w-7xl mx-auto px-6 py-32">
          <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
            ...
            <button onClick={() => navigate("/login")} className="inline-flex items-center gap-2 px-8 py-4 bg-white text-blue-600 font-bold rounded-xl hover:bg-blue-50 transition-colors relative z-10">
