  ...
  return (
    <div className="min-h-screen bg-[#0A0E14] text-[#E8A20E] p-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-[#F5B80B] mb-2">SETTINGS</h1>
          <p className="text-[#E8A20E] text-sm">Configure your trading bot platform</p>
        </div>

        <div className="hud-panel mb-6">
          <h2 className="text-lg font-bold text-[#F5B80B] mb-4">DERIV API TOKEN</h2>
          <div className="space-y-4">
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">API Token</label>
              <Input
                type="password"
              ...
              />
              <p className="text-xs text-[#E8A20E]/60 mt-2">
                Generated from Deriv app settings. Demo recommended for testing.
              </p>
            </div>
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">Account Type</label>
              <div className="flex gap-2">
                <button onClick={() => setAccountType("demo")} className={`flex-1 py-2 px-4 rounded text-sm font-bold transition-colors ${accountType === "demo" ? "bg-[#E8A20E] text-[#0A0E14]" : "bg-[#151B23] text-[#64748B] border border-[#252B35]"}`}>DEMO</button>
                <button onClick={() => setAccountType("real")} className={`flex-1 py-2 px-4 rounded text-sm font-bold transition-colors ${accountType === "real" ? "bg-[#DC3545] text-white" : "bg-[#151B23] text-[#64748B] border border-[#252B35]"}`}>REAL</button>
              </div>
            </div>
            <Button
              onClick={handleSaveDerivToken}
              disabled={saveDerivTokenMutation.isPending || !tokenChanged}
              className="w-full bg-[#E8A20E] text-[#0A0E14] hover:bg-[#E8A20E]/80 font-bold py-2 px-4 rounded"
            >
        ...
        <div className="hud-panel mb-6">
          <h2 className="text-lg font-bold text-[#F5B80B] mb-4">TELEGRAM NOTIFICATIONS</h2>
          <div className="space-y-4">
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">Chat ID</label>
              <Input
        ...
        <div className="hud-panel mb-6">
          <h2 className="text-lg font-bold text-[#F5B80B] mb-4">NOTIFICATION PREFERENCES</h2>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <label className="text-sm text-[#E8A20E]">Trade Executed</label>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm text-[#E8A20E]">Take Profit Hit</label>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm text-[#E8A20E]">Stop Loss Hit</label>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <label className="text-sm text-[#E8A20E]">Bot Error</label>
              <Switch
            ...
            <Button
              ...
              className="w-full bg-[#E8A20E] text-[#0A0E14] hover:bg-[#E8A20E]/80 font-bold py-2 px-4 rounded mt-4"
            >
        ...
        <div className="hud-panel mb-6">
          <h2 className="text-lg font-bold text-[#F5B80B] mb-4 flex items-center gap-2">
            <Brain className="w-5 h-5" /> AI MEMORY â€” TRADER PROFILE
          </h2>
          <p className="text-xs text-[#E8A20E]/70 mb-4">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">Preferred symbols (comma separated)</label>
              <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-sm text-[#E8A20E] block mb-2">Risk % per trade</label>
                <Input
                  type="number"
                  placeholder="2"
                  value={memRisk}
              ...
              <div className="flex items-end">
                <label className="flex items-center gap-2 text-sm text-[#E8A20E] cursor-pointer">
            ...
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">Trading style</label>
              <Input
            ...
            <div>
              <label className="text-sm text-[#E8A20E] block mb-2">Notes for 369AI</label>
              <Input
            ...
            <Button
              ...
              className="w-full bg-[#F5B80B] text-[#0A0E14] hover:bg-[#F5B80B]/80 font-bold py-2 px-4 rounded"
            >
        ...
        <div className="hud-panel mb-6">
          <h2 className="text-lg font-bold text-[#F5B80B] mb-4">ACCOUNT</h2>
          <div className="space-y-4">
            <p className="text-sm text-[#E8A20E]/80">Signed in as <span className="text-[#E8A20E] font-semibold">{user?.email || (user as any)?.username || "user"}</span></p>
            <Button
              onClick={logout}
              className="w-full bg-[#DC3545]/20 text-[#DC3545] border border-[#DC3545]/40 hover:bg-[#DC3545]/30 font-bold py-2 px-4 rounded"
            >
              LOGOUT
            </Button>
          </div>
