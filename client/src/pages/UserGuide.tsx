...
const SECTIONS = [
  ...
  },
  {
    ...
    content: [
      { heading: "Chat Interface", body: '369AI is a conversational assistant. Type any trading-related question and the AI responds with data from your account and live market conditions. The chat supports markdown formatting in responses.' },
  ...
  },
  {
    ...
    content: [
      ...
      { heading: "AI Model Configuration", body: 'In the 369AI chat, click "Model" to choose which AI provider/model powers 369AI\'s responses. Options: OpenAI (GPT-4o, GPT-4o-mini), Anthropic (Claude), Google (Gemini), Mistral, or custom endpoint. Requires the corresponding API key in your server environment variables.' },
  ...
  },
  {
    ...
    content: [
      { heading: "Performance Overview", body: 'The AI Performance page tracks how accurate 369AI\'s predictions have been over time. Metrics include: overall prediction accuracy, accuracy by symbol, accuracy by contract type, confidence vs. outcome breakdown, and accuracy trend over time.' },
