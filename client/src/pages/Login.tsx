...
export default function Login() {
  ...
  // Which optional integrations the server actually has credentials for.
  // Unconfigured OAuth buttons used to render for every visitor and 503 on
  // click — the first thing a new user saw was broken controls.
  const integrationsQ = trpc.auth.integrationStatus.useQuery();
  const oauthConfigured = (p: "google" | "github") => integrationsQ.data?.[p] === true;
