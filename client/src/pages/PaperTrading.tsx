      ...
      <div className="max-w-3xl mx-auto text-center space-y-8 pt-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-2xl mx-auto">
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
            <BarChart3 className="w-6 h-6 text-[var(--cyan)] mx-auto mb-2" />
            <p className="text-sm font-bold text-white">Dashboard</p>
            <p className="text-[10px] text-[var(--text-muted)]">Monitor paper trades live</p>
          </div>
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
            <Shield className="w-6 h-6 text-[var(--green)] mx-auto mb-2" />
            <p className="text-sm font-bold text-white">No Risk</p>
            <p className="text-[10px] text-[var(--text-muted)]">Virtual funds only</p>
          </div>
          <div className="bg-[var(--card)] border border-[var(--border)] rounded-xl p-5">
            <Zap className="w-6 h-6 text-[var(--amber)] mx-auto mb-2" />
            <p className="text-sm font-bold text-white">Real Market</p>
            <p className="text-[10px] text-[var(--text-muted)]">Live data from Deriv</p>
          </div>
        </div>
        <Button onClick={() => navigate("/dashboard")} className="bg-[var(--amber)] text-black font-bold px-8 py-3 rounded-xl text-sm">
